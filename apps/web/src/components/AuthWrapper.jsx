...
const AuthWrapper = ({ type }) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      const {
        data: { user, jwt },
      } = await axios.post(type === "login" ? LOGIN_ROUTE : SIGNUP_ROUTE, values, {
      ...
      if (axios.isAxiosError(err)) {
        ...
        const message =
          typeof data === "string" ? data : data?.error || data?.message || "An error occurred";
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center p-8 gap-7">
            <h3 className="text-2xl font-semibold text-slate-700">
              {type === "login" ? "Nice to see you again ! " : "Start your journey with us!"}
            </h3>
            ...
            <div className="flex flex-col gap-5">
              ...
              {type === "login" && (
                <span
                  ...
                  onClick={() =>
                    alert("Hey, forgetful genius! Relax and try to remember your password! 🔍")
                  }
                >
                  Forgot Password?
                </span>
