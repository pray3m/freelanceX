        ...
        <>
          ...
          >
            <div className="flex items-center">
              <Link href="/">
                <p className={!navFixed && !userInfo ? "text-[#fff]" : "text-[#404145]"}>
                  <span className="text-2xl md:text-3xl font-semibold flex items-center">
                    <i>freelance</i> <b className="text-green-700 text-3xl md:text-4xl">X</b>
                  </span>
                </p>
              </Link>
            </div>

            <div className={`hidden lg:flex ${navFixed || userInfo ? "opacity-100" : "opacity-0"}`}>
              <input
                type="text"
          ...
          >
            <button className="absolute right-4 top-6" onClick={() => setIsOpen(false)}>
              <RxCross1 size={32} />
            </button>
                  ...
                  <div className="py-4 flex flex-col items-center">
                    {links.map(({ linkName, handler, type }) => (
                      ...
                      >
                        ...
                        {type === "button" && <button className="w-full">{linkName}</button>}
                        {type === "button2" && (
